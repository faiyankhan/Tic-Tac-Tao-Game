...
Player 1 (X) clicks on a cell to place their symbol.<br>
Player 2 (O) then clicks on an empty cell to place their symbol.<br>
Continue taking turns until a player gets three symbols in a row or all cells are filled (resulting in a draw).<br>
The game will announce the winner or if the game is a draw.<br>
